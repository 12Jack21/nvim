...
local function load_options()
	local global_local = {
		...
		clipboard = "unnamedplus", -- for macos clipboard
		cmdheight = 1, -- 0, 1, 2
		cmdwinheight = 5,
		complete = ".,w,b,k",
		...
		concealcursor = "niv",
		conceallevel = 0,
		cursorcolumn = false, -- a column line for cursor
		cursorline = true,
		...
		-- whichwrap = "h,l,<,>,[,],~",
		whichwrap = "",
		wildignore = ".dSYM,.git,.hg,.svn,*.pyc,*.o,*.out,*.jpg,*.jpeg,*.png,*.gif,*.zip,**/tmp/**,*.DS_Store,**/node_modules/**,**/bower_modules/**",
		wildignorecase = true,
		winminwidth = 10,
		winwidth = 30,
		wrap = false,
